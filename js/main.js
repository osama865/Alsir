...
var counter;
function counterUp(){
	$(".love").animateNumber({number: love,},500);$(".cline").animateNumber({number: cline,},500);$(".disLike").animateNumber({number: disLike,},500);$(".backUs").animateNumber({number: backUs,},500);
...
if (phoneNumber.length < 10 ) {
	$(".checkPhone").text("عزرا رقم هاتفك اقل من عشره ارقام").css({"color":"red", "font-size":"130%", "text-align":"right"})
}else
if (phoneNumber.length == 10) {$(".checkPhone").text("جيد الرقم صحيح").css({"color":"green", "font-size":"130%", "text-align":"right"})}else
$(".checkPhone").text("عزرا رقم هاتفك اكثر من عشره ارقام").css({"color":"red", "font-size":"130%", "text-align":"right"});
});
